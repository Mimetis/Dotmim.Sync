...
namespace Dotmim.Sync
{
    ...
    public static partial class HttpInterceptorsExtensions
    {
        ...
        /// </summary>
        public static Guid OnHttpGettingSchemaRequest(this WebClientOrchestrator orchestrator, Action<HttpGettingSchemaRequestArgs> action)
            => orchestrator.AddInterceptor(action);

        /// <summary>
        /// Intercept the provider when an http call is about to be made to get server schema
        /// </summary>
        public static Guid OnHttpGettingSchemaRequest(this WebClientOrchestrator orchestrator, Func<HttpGettingSchemaRequestArgs, Task> action)
            => orchestrator.AddInterceptor(action);

        /// <summary>
        /// Intercept the provider when an http call to get schema is done
        /// </summary>
        public static Guid OnHttpGettingSchemaResponse(this WebClientOrchestrator orchestrator, Action<HttpGettingSchemaResponseArgs> action)
            => orchestrator.AddInterceptor(action);

        /// <summary>
        /// Intercept the provider when an http call to get schema is done
        /// </summary>
        public static Guid OnHttpGettingSchemaResponse(this WebClientOrchestrator orchestrator, Func<HttpGettingSchemaResponseArgs, Task> action)
            => orchestrator.AddInterceptor(action);
    }
}
