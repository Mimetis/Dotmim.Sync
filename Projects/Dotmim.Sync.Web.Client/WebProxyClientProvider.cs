...
namespace Dotmim.Sync.Web.Client
{
    ...
    public class WebProxyClientProvider : IDisposable
    {
      ...
      /// <summary>
        ...
        //    var httpMessageResponse = await this.httpRequestHandler.ProcessRequest(httpMessage, context.SessionId, SerializationFormat.Json, this.cancellationToken).ConfigureAwait(false);
        ...
        //    //Post request and get response
        //    var httpMessageResponse = await this.httpRequestHandler.ProcessRequest(message, context.SessionId, SerializationFormat.Json, this.cancellationToken).ConfigureAwait(false);
        ...
        //    //Post request and get response
        //    var httpMessageResponse = await this.httpRequestHandler.ProcessRequest(httpMessage, context.SessionId, message.SerializationFormat, this.cancellationToken).ConfigureAwait(false);
        ...
        //        var httpMessageResponse = await this.httpRequestHandler.ProcessRequestAsync(httpMessage, context.SessionId, message.SerializationFormat, this.cancellationToken).ConfigureAwait(false);
        ...
        //    {
        //        var applyChanges = new HttpMessageSendChangesRequest
        //        {
        ...
        //        if (httpMessageResponse.Content is HttpMessageSendChangesRequest)
        //            httpMessageContent = httpMessageResponse.Content as HttpMessageSendChangesRequest;
        //        else
        //            httpMessageContent = (httpMessageResponse.Content as JObject).ToObject<HttpMessageSendChangesRequest>();
