...
{
    public class NpgsqlManagerTable : IDbTableManager
    {
        ...
        public NpgsqlManagerTable(DbConnection connection, DbTransaction transaction = null)
        {
        ...
        {
            var syncTable = await NpgsqlManagementUtils.GetTableAsync(this.connection, this.transaction, this.tableName, this.schemaName).ConfigureAwait(false);
        ...
        public async Task<IEnumerable<DbRelationDefinition>> GetRelationsAsync()
        {
            ...
            var tableRelations = await NpgsqlManagementUtils.GetRelationsForTableAsync(this.connection, this.transaction, this.tableName, this.schemaName).ConfigureAwait(false);
        ...
        public async Task<IEnumerable<SyncColumn>> GetColumnsAsync() 
        {
            ...
            var syncTableColumnsList = await NpgsqlManagementUtils.GetColumnsForTableAsync(this.connection, this.transaction, this.tableName, this.schemaName).ConfigureAwait(false);
            var sqlDbMetadata = new NpgsqlDbMetadata();
        ...
        {
            var syncTableKeys = await NpgsqlManagementUtils.GetPrimaryKeysForTableAsync(this.connection, this.transaction, this.tableName, this.schemaName).ConfigureAwait(false);
