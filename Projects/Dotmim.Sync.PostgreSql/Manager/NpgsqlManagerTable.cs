...
namespace Dotmim.Sync.SqlServer.Manager
{
    public class SqlManagerTable : IDbTableManager
    {
        ...
        {
            var syncTable = await NpgsqlManagementUtils.GetTableAsync(this.sqlConnection, this.sqlTransaction, this.tableName, this.schemaName).ConfigureAwait(false);
        ...
        public async Task<IEnumerable<DbRelationDefinition>> GetRelationsAsync()
        {
            ...
            var tableRelations = await NpgsqlManagementUtils.GetRelationsForTableAsync(this.sqlConnection, this.sqlTransaction, this.tableName, this.schemaName).ConfigureAwait(false);
        ...
        public async Task<IEnumerable<SyncColumn>> GetColumnsAsync() 
        {
            ...
            var syncTableColumnsList = await NpgsqlManagementUtils.GetColumnsForTableAsync(this.sqlConnection, this.sqlTransaction, this.tableName, this.schemaName).ConfigureAwait(false);
        ...
        {
            var syncTableKeys = await NpgsqlManagementUtils.GetPrimaryKeysForTableAsync(this.sqlConnection, this.sqlTransaction, this.tableName, this.schemaName).ConfigureAwait(false);
