...
namespace Dotmim.Sync.Data.Surrogate
{
    ...
    public class DmTableSurrogate : IDisposable
    {
        ...
        /// <summary>Gets an array of <see cref="T:Microsoft.Synchronization.Dm.DmColumnSurrogate" /> objects that comprise the table that is represented by the <see cref="T:Microsoft.Synchronization.Dm.DmTableSurrogate" /> object.</summary>
        /// <returns>An array of <see cref="T:Microsoft.Synchronization.Dm.DmColumnSurrogate" /> objects.</returns>
        ...
        /// <summary>Initializes a new instance of the DmTableSurrogate class.</summary>
