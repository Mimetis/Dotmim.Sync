...
//            this.TrackingTablesPrefix = ds.TrackingTablesPrefix;
//            this.TrackingTablesSuffix = ds.TrackingTablesSuffix;
//            this.StoredProceduresPrefix = ds.StoredProceduresPrefix;
//            this.StoredProceduresSuffix = ds.StoredProceduresSuffix;
//            this.TriggersPrefix = ds.TriggersPrefix;
//            this.TriggersSuffix = ds.TriggersSuffix;
...
//            var rowState = (DmRowState)Convert.ToInt32(row[0], dt.Culture);
