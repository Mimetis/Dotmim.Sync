...
namespace Dotmim.Sync
{
    public abstract partial class BaseOrchestrator
    {
        ...
        //        tableConflictApplied.HasBeenMarkForNextSync = false;
        ...
        //        return (context, tableConflictApplied);
        //    }
        //    else if (conflictApplyAction == ApplyAction.RetryOnNextSync)
        //    {
        //        tableConflictApplied.HasBeenApplied = false;
        //        tableConflictApplied.HasBeenResolved = false;
        //        tableConflictApplied.HasBeenMarkForNextSync = true;
        //        tableConflictApplied.Exception = new RollbackException("Rollback action taken on conflict");
        //        return (context, tableConflictApplied);
        //    }
        ...
        //    //else if (resolution == ConflictResolution.RetryOnNextSync)
        //    //    action = ApplyAction.RetryOnNextSync;
        ...
        /// The int returned is the conflict count I need 
        /// </summary>
        private async Task<(bool applied, bool conflictResolved, Exception ex)>
            HandleConflictAsync(ScopeInfo scopeInfo, SyncContext context,
                                Guid localScopeId, Guid senderScopeId, SyncRow conflictRow,
                                SyncTable schemaChangesTable,
                                ConflictResolutionPolicy policy, long? lastTimestamp,
