...
namespace Dotmim.Sync.Sqlite
{
    public class SqliteObjectNames
    {
        ...
        private void CreateSelectChangesCommandText()
        {
            ...
            var selectSql = stringBuilder.ToString();
            this.AddCommandName(DbCommandType.SelectChanges, selectSql);
            this.AddCommandName(DbCommandType.SelectChangesWithFilters, selectSql);
        }
