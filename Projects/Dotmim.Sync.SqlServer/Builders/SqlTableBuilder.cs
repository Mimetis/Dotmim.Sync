...
namespace Dotmim.Sync.SqlServer.Builders
{
    ...
    public class SqlTableBuilder : DbTableBuilder
    {
            ...
            : base(tableDescription, tableName, trackingTableName, setup, scopeName)
        {
            ...
            this.sqlBuilderProcedure = new SqlBuilderProcedure(tableDescription, tableName, trackingTableName, this.Setup, scopeName);
            this.sqlBuilderTable = new SqlBuilderTable(tableDescription, tableName, trackingTableName, this.Setup);
            this.sqlBuilderTrackingTable = new SqlBuilderTrackingTable(tableDescription, tableName, trackingTableName, this.Setup);
            this.sqlBuilderTrigger = new SqlBuilderTrigger(tableDescription, tableName, trackingTableName, this.Setup, scopeName);
        }
