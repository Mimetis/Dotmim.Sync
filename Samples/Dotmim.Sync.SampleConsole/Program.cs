...
internal class Program
{
    ...
    {
        // Create databases 
        await DbHelper.EnsureDatabasesAsync(serverDbName, clientDbName);
    ...
    private static async Task SynchronizeAsync()
    {
        ...
        var interceptor = new Interceptor<ApplyChangesFailedArgs>(args => args.Resolution = ConflictResolution.ServerWins);
