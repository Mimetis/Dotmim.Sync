...
namespace Dotmim.Sync.Tests.StandAlone
{
    public class SerializerTests
    {
        ...
        private static ContainerSet CreateContainer()
        {

            var set = new DataSet("AdventureWorks");

            var tbl = new DataTable("ServiceTickets");
            set.Tables.Add(tbl);

            tbl.Columns.Add(new DataColumn("ServiceTicketID", typeof(Guid)));
            tbl.Columns.Add(new DataColumn("Title", typeof(string)));
            tbl.Columns.Add(new DataColumn("Description", typeof(string)));
            tbl.Columns.Add(new DataColumn("StatusValue", typeof(int)));
            tbl.Columns.Add(new DataColumn("EscalationLevel", typeof(int)));
            tbl.Columns.Add(new DataColumn("Opened", typeof(DateTime)));
            tbl.Columns.Add(new DataColumn("CustomerID", typeof(int)));
            ...
            ContainerSet container = new ContainerSet(set);
