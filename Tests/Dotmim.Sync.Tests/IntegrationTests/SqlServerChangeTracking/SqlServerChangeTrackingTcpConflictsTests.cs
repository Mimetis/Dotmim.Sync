...
{
    public class SqlServerChangeTrackingTcpConflictsTests : TcpConflictsTests
    {
        public override List<ProviderType> ClientsType => new List<ProviderType>
           {  ProviderType.Sql, ProviderType.Sqlite};

        public SqlServerChangeTrackingTcpConflictsTests(HelperProvider fixture, ITestOutputHelper output) : base(fixture, output)
        {
        }
...
#pragma warning disable xUnit1026 // Theory methods should use all of their parameters
        public override Task Conflict_UC_OUTDATED_ServerShouldWins(SyncOptions options) => Task.CompletedTask;
#pragma warning restore xUnit1026 // Theory methods should use all of their parameters

        [Theory]
        [ClassData(typeof(SyncOptionsData))]
#pragma warning disable xUnit1026 // Theory methods should use all of their parameters
        public override Task Conflict_UC_OUTDATED_ServerShouldWins_EvenIf_ResolutionIsClientWins(SyncOptions options) => Task.CompletedTask;
#pragma warning restore xUnit1026 // Theory methods should use all of their parameters

        [Theory]
        [ClassData(typeof(SyncOptionsData))]
#pragma warning disable xUnit1026 // Theory methods should use all of their parameters
        public override Task Conflict_DC_DS_ClientShouldWins(SyncOptions options) => Task.CompletedTask;
#pragma warning restore xUnit1026 // Theory methods should use all of their parameters

        [Theory]
        [ClassData(typeof(SyncOptionsData))]
#pragma warning disable xUnit1026 // Theory methods should use all of their parameters
        public override Task Conflict_DC_DS_ClientShouldWins_CozHandler(SyncOptions options) => Task.CompletedTask;
#pragma warning restore xUnit1026 // Theory methods should use all of their parameters
