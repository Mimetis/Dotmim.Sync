...
namespace Dotmim.Sync.Tests.Scenarios
{
    public partial class SqlServerTcpFilterTests : IDisposable
    {
        ...
        public SqlServerTcpFilterTests(ITestOutputHelper output)
        {
        ...
        [Fact, TestPriority(1)]
        public virtual async Task Filtering_With_NotSynced_Column()
        {
            await HelperDatabase.CreateDatabaseAsync(ProviderType.Sql, ServerDatabaseName, true);

            // Create a table with a ProductCategoryID, that will be part of the Filter, but will not be synced
            var createProducTable = @"CREATE TABLE [dbo].[Product](
	                                    [ProductID] [int] IDENTITY(1,1) NOT NULL PRIMARY KEY,
	                                    [ProductCategoryID] [int] NOT NULL,
	                                    [Name] [nvarchar](50) NOT NULL);
                                      INSERT INTO [Product] VALUES (1, 'GEAR 02');
                                      INSERT INTO [Product] VALUES (1, 'GEAR 01');";
            ...
            this.WebServerOrchestrator.Setup.Filters.Add("Product", "ProductCategoryID");
