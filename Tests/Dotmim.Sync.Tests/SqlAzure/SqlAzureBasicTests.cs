...
namespace Dotmim.Sync.Tests.SqlAzure
{
    ...
    [Collection("SqlAzure")]
    public class SqlAzureBasicTests : BasicTestsBase, IClassFixture<SqlAzureFixture>
    {
        static SqlAzureBasicTests()
        {
        ...
        public SqlAzureBasicTests(SqlAzureFixture fixture) : base(fixture)
        {
